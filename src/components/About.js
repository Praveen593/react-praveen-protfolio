...
export default function About(){
    return <section className=' flex flex-col w-full h-full md:flex-row bg-white md:h-full md:w-full ' id="About">
        <motion.div initial={{x:-100 , opacity: 0}} whileInView={{x:0 , opacity: 1}} transition={{duration:0.5 , delay: 0.5}} className='md:w-1/2'>
        ...
        <motion.div initial={{x:100 , opacity: 0}} whileInView={{x:0 , opacity: 1}} transition={{duration:0.5 , delay: 0.5}} className='md:w-1/2 mb-5'>
