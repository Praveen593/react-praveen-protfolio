...
export default function Skills(){
    return <div>
        <section className="pb-14" id="Skills">
                <motion.h1 initial={{y:-100 , opacity: 0}} whileInView={{y:0, opacity: 1}} transition={{duration:0.5, delay:0.2}} className="my-10 font-PriFont volite-color-text font-semibold text-center text-3xl md:text-4xl">Technologies I know</motion.h1>
                <motion.div initial={{y:-100 , opacity: 0}} whileInView={{y:0, opacity: 1}} transition={{duration:0.5, delay:0.2}} className="flex flex-wrap items-center justify-center gap-11 mx-10">
                    ...
                    <SiHtml5 className="text-5xl md:text-5xl text-orange-600"/>
                    </motion.div>
                    ...
                    <SiCss3  className="text-5xl md:text-5xl text-sky-500"/>
                    </motion.div>
                    ...
                    <RiJavascriptFill className=" text-5xl md:text-5xl text-yellow-300"/>
                    </motion.div>
                    ...
                    <FaReact className=" text-5xl md:text-5xl text-sky-400"/>
                    </motion.div>
                    ...
                    <RiTailwindCssFill className=" text-5xl md:text-5xl text-sky-500"/>
                    </motion.div>
                    ...
                    <SiMongodb className=" text-5xl md:text-5xl text-green-600"/>
                    </motion.div>
                </motion.div>
